...
linia PROC
	...
	sub cs:adres_nastepny, word ptr 320
	mov bx, cs:adres_nastepny
	...
	adres_piksela dw 320*199 ; bieżący adres piksela
	adres_nastepny dw 320*199 ; nastepny adres piksela
	wektor8 dd ?
linia ENDP
