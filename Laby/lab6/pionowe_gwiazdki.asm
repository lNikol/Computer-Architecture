...
obsluga_zegara PROC
	...
	; zwiększienie o 160 adresu bieżącego w pamięci ekranu
	add bx,160	
	...
	mov bx, cs:plus
	mov cs:licznik_wierszy, word ptr 1 ; liczę liczbę wierszy
	jmp sprawdz
...
zacznij:
	mov al, 0
	mov ah, 5
	int 10 ; włączenie trybu graficznego BIOS / przerwanie
	mov ax, 0
